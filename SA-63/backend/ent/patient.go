...
func (e PatientEdges) StatisticOrErr() ([]*Statistic, error) {
	if e.loadedTypes[0] {
...
// QueryStatistic queries the statistic edge of the Patient.
func (pa *Patient) QueryStatistic() *StatisticQuery {
	return (&PatientClient{config: pa.config}).QueryStatistic(pa)
}
