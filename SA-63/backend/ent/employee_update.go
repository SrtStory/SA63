...
func (eu *EmployeeUpdate) AddStatisticIDs(ids ...int) *EmployeeUpdate {
	eu.mutation.AddStatisticIDs(ids...)
	return eu
}

// AddStatistic adds the statistic edges to Statistic.
func (eu *EmployeeUpdate) AddStatistic(s ...*Statistic) *EmployeeUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return eu.AddStatisticIDs(ids...)
}
...
func (eu *EmployeeUpdate) RemoveStatisticIDs(ids ...int) *EmployeeUpdate {
	eu.mutation.RemoveStatisticIDs(ids...)
	return eu
}

// RemoveStatistic removes statistic edges to Statistic.
func (eu *EmployeeUpdate) RemoveStatistic(s ...*Statistic) *EmployeeUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return eu.RemoveStatisticIDs(ids...)
}
...
func (eu *EmployeeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := eu.mutation.RemovedStatisticIDs(); len(nodes) > 0 {
	...
	if nodes := eu.mutation.StatisticIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   employee.StatisticTable,
...
// AddStatisticIDs adds the statistic edge to Statistic by ids.
func (euo *EmployeeUpdateOne) AddStatisticIDs(ids ...int) *EmployeeUpdateOne {
	euo.mutation.AddStatisticIDs(ids...)
	return euo
}

// AddStatistic adds the statistic edges to Statistic.
func (euo *EmployeeUpdateOne) AddStatistic(s ...*Statistic) *EmployeeUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return euo.AddStatisticIDs(ids...)
}
...
// RemoveStatisticIDs removes the statistic edge to Statistic by ids.
func (euo *EmployeeUpdateOne) RemoveStatisticIDs(ids ...int) *EmployeeUpdateOne {
	euo.mutation.RemoveStatisticIDs(ids...)
	return euo
}

// RemoveStatistic removes statistic edges to Statistic.
func (euo *EmployeeUpdateOne) RemoveStatistic(s ...*Statistic) *EmployeeUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return euo.RemoveStatisticIDs(ids...)
}
...
func (euo *EmployeeUpdateOne) sqlSave(ctx context.Context) (e *Employee, err error) {
	...
	if nodes := euo.mutation.RemovedStatisticIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   employee.StatisticTable,
	...
	if nodes := euo.mutation.StatisticIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   employee.StatisticTable,
