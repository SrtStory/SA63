...
func (e EmployeeEdges) StatisticOrErr() ([]*Statistic, error) {
	if e.loadedTypes[0] {
...
// QueryStatistic queries the statistic edge of the Employee.
func (e *Employee) QueryStatistic() *StatisticQuery {
	return (&EmployeeClient{config: e.config}).QueryStatistic(e)
}
